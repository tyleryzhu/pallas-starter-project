...
struct AT_API Type {
  ...
  virtual Tensor th_clone(const Tensor & self) const;
  virtual Tensor view(const Tensor & self, IntList size) const;
  virtual Tensor & th_resize_as_(Tensor & self, const Tensor & the_template) const;
  ...
  virtual std::tuple<Tensor &,Tensor &> _th_min_out(Tensor & min, Tensor & min_indices, const Tensor & self, int64_t dim, bool keepdim=false) const;
  virtual std::tuple<Tensor,Tensor> _th_min(const Tensor & self, int64_t dim, bool keepdim=false) const;
  ...
  virtual std::tuple<Tensor &,Tensor &> _th_max_out(Tensor & max, Tensor & max_indices, const Tensor & self, int64_t dim, bool keepdim=false) const;
  virtual std::tuple<Tensor,Tensor> _th_max(const Tensor & self, int64_t dim, bool keepdim=false) const;
  virtual std::tuple<Tensor &,Tensor &> _th_kthvalue_out(Tensor & values, Tensor & indices, const Tensor & self, int64_t k, int64_t dim=-1, bool keepdim=false) const;
  virtual std::tuple<Tensor,Tensor> _th_kthvalue(const Tensor & self, int64_t k, int64_t dim=-1, bool keepdim=false) const;
  virtual std::tuple<Tensor &,Tensor &> _th_mode_out(Tensor & values, Tensor & indices, const Tensor & self, int64_t dim=-1, bool keepdim=false) const;
  virtual std::tuple<Tensor,Tensor> _th_mode(const Tensor & self, int64_t dim=-1, bool keepdim=false) const;
  virtual Tensor median(const Tensor & self) const;
  virtual std::tuple<Tensor &,Tensor &> _th_median_out(Tensor & values, Tensor & indices, const Tensor & self, int64_t dim, bool keepdim=false) const;
  virtual std::tuple<Tensor,Tensor> _th_median(const Tensor & self, int64_t dim, bool keepdim=false) const;
  ...
  virtual Tensor & _th_all_out(Tensor & result, const Tensor & self, int64_t dim, bool keepdim=false) const;
  virtual Tensor _th_all(const Tensor & self, int64_t dim, bool keepdim=false) const;
  virtual Tensor any(const Tensor & self) const;
  virtual Tensor & _th_any_out(Tensor & result, const Tensor & self, int64_t dim, bool keepdim=false) const;
  virtual Tensor _th_any(const Tensor & self, int64_t dim, bool keepdim=false) const;
  virtual int64_t _th_get_device(const Tensor & self) const;
  virtual Tensor & _abs_out(Tensor & result, const Tensor & self) const;
  virtual Tensor _abs(const Tensor & self) const;
  virtual Tensor & _th_sigmoid_out(Tensor & result, const Tensor & self) const;
  virtual Tensor _th_sigmoid(const Tensor & self) const;
  ...
  virtual Tensor & _erfc_out(Tensor & result, const Tensor & self) const;
  virtual Tensor _erfc(const Tensor & self) const;
  ...
  virtual Tensor & _th_var_out(Tensor & result, const Tensor & self, int64_t dim, bool unbiased=true, bool keepdim=false) const;
  virtual Tensor _th_var(const Tensor & self, int64_t dim, bool unbiased=true, bool keepdim=false) const;
  virtual Tensor _th_var(const Tensor & self, bool unbiased=true) const;
  virtual Tensor & _th_std_out(Tensor & result, const Tensor & self, int64_t dim, bool unbiased=true, bool keepdim=false) const;
  virtual Tensor _th_std(const Tensor & self, int64_t dim, bool unbiased=true, bool keepdim=false) const;
  virtual Tensor _th_std(const Tensor & self, bool unbiased=true) const;
  virtual Tensor th_norm(const Tensor & self, Scalar p=2) const;
  virtual Tensor & _th_norm_out(Tensor & result, const Tensor & self, Scalar p, int64_t dim, bool keepdim=false) const;
  virtual Tensor _th_norm(const Tensor & self, Scalar p, int64_t dim, bool keepdim=false) const;
  ...
  virtual Tensor & th_pow_out(Tensor & result, const Tensor & self, Scalar exponent) const;
  virtual Tensor th_pow(const Tensor & self, Scalar exponent) const;
  ...
  virtual Tensor & th_zero_(Tensor & self) const;
  ...
  Tensor & th_add_out(Tensor & result, const Tensor & self, const Tensor & other, Scalar alpha=1) const;
  virtual Tensor & s_th_add_out(Tensor & result, const Tensor & self, const Tensor & other, Scalar alpha=1) const;
  Tensor th_add(const Tensor & self, const Tensor & other, Scalar alpha=1) const;
  virtual Tensor s_th_add(const Tensor & self, const Tensor & other, Scalar alpha=1) const;
  ...
  Tensor & th_add_(Tensor & self, const Tensor & other, Scalar alpha=1) const;
  virtual Tensor & s_th_add_(Tensor & self, const Tensor & other, Scalar alpha=1) const;
  virtual Tensor & add_(Tensor & self, Scalar other, Scalar alpha=1) const;
  Tensor & th_sub_out(Tensor & result, const Tensor & self, const Tensor & other, Scalar alpha=1) const;
  virtual Tensor & s_th_sub_out(Tensor & result, const Tensor & self, const Tensor & other, Scalar alpha=1) const;
  Tensor th_sub(const Tensor & self, const Tensor & other, Scalar alpha=1) const;
  virtual Tensor s_th_sub(const Tensor & self, const Tensor & other, Scalar alpha=1) const;
  ...
  Tensor & th_sub_(Tensor & self, const Tensor & other, Scalar alpha=1) const;
  virtual Tensor & s_th_sub_(Tensor & self, const Tensor & other, Scalar alpha=1) const;
  virtual Tensor & sub_(Tensor & self, Scalar other, Scalar alpha=1) const;
  virtual Tensor & th_mul_out(Tensor & result, const Tensor & self, Scalar other) const;
  virtual Tensor th_mul(const Tensor & self, Scalar other) const;
  Tensor & th_mul_out(Tensor & result, const Tensor & self, const Tensor & other) const;
  virtual Tensor & s_th_mul_out(Tensor & result, const Tensor & self, const Tensor & other) const;
  Tensor th_mul(const Tensor & self, const Tensor & other) const;
  virtual Tensor s_th_mul(const Tensor & self, const Tensor & other) const;
  virtual Tensor & th_mul_(Tensor & self, Scalar other) const;
  Tensor & th_mul_(Tensor & self, const Tensor & other) const;
  virtual Tensor & s_th_mul_(Tensor & self, const Tensor & other) const;
  virtual Tensor & th_div_out(Tensor & result, const Tensor & self, Scalar other) const;
  virtual Tensor th_div(const Tensor & self, Scalar other) const;
  ...
  virtual Tensor & th_div_(Tensor & self, Scalar other) const;
  ...
  Tensor & th_addmm_out(Tensor & result, const Tensor & self, const Tensor & mat1, const Tensor & mat2, Scalar beta=1, Scalar alpha=1) const;
  virtual Tensor & s_th_addmm_out(Tensor & result, const Tensor & self, const Tensor & mat1, const Tensor & mat2, Scalar beta=1, Scalar alpha=1) const;
  Tensor th_addmm(const Tensor & self, const Tensor & mat1, const Tensor & mat2, Scalar beta=1, Scalar alpha=1) const;
  virtual Tensor s_th_addmm(const Tensor & self, const Tensor & mat1, const Tensor & mat2, Scalar beta=1, Scalar alpha=1) const;
  virtual Tensor & th_addmm_(Tensor & self, const Tensor & mat1, const Tensor & mat2, Scalar beta=1, Scalar alpha=1) const;
  ...
  virtual Tensor & _getri_out(Tensor & output, const Tensor & self) const;
  virtual Tensor _getri(const Tensor & self) const;
  ...
  virtual Tensor & _bernoulli_(Tensor & self, double p, Generator * generator=nullptr) const;
  ...
  virtual Tensor th_tensor(IntList size) const;
  virtual Tensor th_tensor() const;
  ...
  virtual Tensor & as_strided_out(Tensor & result, const Tensor & self, IntList size, IntList stride, int64_t storage_offset) const;
  virtual Tensor as_strided(const Tensor & self, IntList size, IntList stride, int64_t storage_offset) const;
  virtual Tensor & as_strided_(Tensor & self, IntList size, IntList stride, int64_t storage_offset) const;
  ...
  virtual Tensor & binary_cross_entropy_out(Tensor & output, const Tensor & self, const Tensor & target, const Tensor & weight={}, int64_t reduction=Reduction::ElementwiseMean) const;
  virtual Tensor binary_cross_entropy(const Tensor & self, const Tensor & target, const Tensor & weight={}, int64_t reduction=Reduction::ElementwiseMean) const;
  virtual Tensor & binary_cross_entropy_forward_out(Tensor & output, const Tensor & self, const Tensor & target, const Tensor & weight, int64_t reduction) const;
  virtual Tensor binary_cross_entropy_forward(const Tensor & self, const Tensor & target, const Tensor & weight, int64_t reduction) const;
  virtual Tensor & binary_cross_entropy_backward_out(Tensor & grad_input, const Tensor & grad_output, const Tensor & self, const Tensor & target, const Tensor & weight, int64_t reduction) const;
  virtual Tensor binary_cross_entropy_backward(const Tensor & grad_output, const Tensor & self, const Tensor & target, const Tensor & weight, int64_t reduction) const;
  virtual Tensor & kl_div_out(Tensor & output, const Tensor & self, const Tensor & target, int64_t reduction=Reduction::ElementwiseMean) const;
  virtual Tensor kl_div(const Tensor & self, const Tensor & target, int64_t reduction=Reduction::ElementwiseMean) const;
  virtual Tensor & kl_div_forward_out(Tensor & output, const Tensor & self, const Tensor & target, int64_t reduction) const;
  virtual Tensor kl_div_forward(const Tensor & self, const Tensor & target, int64_t reduction) const;
  virtual Tensor & kl_div_backward_out(Tensor & grad_input, const Tensor & grad_output, const Tensor & self, const Tensor & target, int64_t reduction) const;
  virtual Tensor kl_div_backward(const Tensor & grad_output, const Tensor & self, const Tensor & target, int64_t reduction) const;
  virtual Tensor & l1_loss_out(Tensor & output, const Tensor & self, const Tensor & target, int64_t reduction=Reduction::ElementwiseMean) const;
  virtual Tensor l1_loss(const Tensor & self, const Tensor & target, int64_t reduction=Reduction::ElementwiseMean) const;
  virtual Tensor & l1_loss_forward_out(Tensor & output, const Tensor & self, const Tensor & target, int64_t reduction) const;
  virtual Tensor l1_loss_forward(const Tensor & self, const Tensor & target, int64_t reduction) const;
  virtual Tensor & l1_loss_backward_out(Tensor & grad_input, const Tensor & grad_output, const Tensor & self, const Tensor & target, int64_t reduction) const;
  virtual Tensor l1_loss_backward(const Tensor & grad_output, const Tensor & self, const Tensor & target, int64_t reduction) const;
  virtual Tensor & mse_loss_out(Tensor & output, const Tensor & self, const Tensor & target, int64_t reduction=Reduction::ElementwiseMean) const;
  virtual Tensor mse_loss(const Tensor & self, const Tensor & target, int64_t reduction=Reduction::ElementwiseMean) const;
  virtual Tensor & mse_loss_forward_out(Tensor & output, const Tensor & self, const Tensor & target, int64_t reduction) const;
  virtual Tensor mse_loss_forward(const Tensor & self, const Tensor & target, int64_t reduction) const;
  virtual Tensor & mse_loss_backward_out(Tensor & grad_input, const Tensor & grad_output, const Tensor & self, const Tensor & target, int64_t reduction) const;
  virtual Tensor mse_loss_backward(const Tensor & grad_output, const Tensor & self, const Tensor & target, int64_t reduction) const;
  virtual Tensor & multi_margin_loss_out(Tensor & output, const Tensor & self, const Tensor & target, Scalar p=1, Scalar margin=1, const Tensor & weight={}, int64_t reduction=Reduction::ElementwiseMean) const;
  virtual Tensor multi_margin_loss(const Tensor & self, const Tensor & target, Scalar p=1, Scalar margin=1, const Tensor & weight={}, int64_t reduction=Reduction::ElementwiseMean) const;
  virtual Tensor & multi_margin_loss_forward_out(Tensor & output, const Tensor & self, const Tensor & target, Scalar p, Scalar margin, const Tensor & weight, int64_t reduction) const;
  virtual Tensor multi_margin_loss_forward(const Tensor & self, const Tensor & target, Scalar p, Scalar margin, const Tensor & weight, int64_t reduction) const;
  virtual Tensor & multi_margin_loss_backward_out(Tensor & grad_input, const Tensor & grad_output, const Tensor & self, const Tensor & target, Scalar p, Scalar margin, const Tensor & weight, int64_t reduction) const;
  virtual Tensor multi_margin_loss_backward(const Tensor & grad_output, const Tensor & self, const Tensor & target, Scalar p, Scalar margin, const Tensor & weight, int64_t reduction) const;
  virtual Tensor & multilabel_margin_loss_out(Tensor & output, const Tensor & self, const Tensor & target, int64_t reduction=Reduction::ElementwiseMean) const;
  virtual Tensor multilabel_margin_loss(const Tensor & self, const Tensor & target, int64_t reduction=Reduction::ElementwiseMean) const;
  virtual std::tuple<Tensor &,Tensor &> multilabel_margin_loss_forward_out(Tensor & output, Tensor & is_target, const Tensor & self, const Tensor & target, int64_t reduction) const;
  virtual std::tuple<Tensor,Tensor> multilabel_margin_loss_forward(const Tensor & self, const Tensor & target, int64_t reduction) const;
  virtual Tensor & multilabel_margin_loss_backward_out(Tensor & grad_input, const Tensor & grad_output, const Tensor & self, const Tensor & target, int64_t reduction, const Tensor & is_target) const;
  virtual Tensor multilabel_margin_loss_backward(const Tensor & grad_output, const Tensor & self, const Tensor & target, int64_t reduction, const Tensor & is_target) const;
  virtual Tensor & nll_loss_out(Tensor & output, const Tensor & self, const Tensor & target, const Tensor & weight={}, int64_t reduction=Reduction::ElementwiseMean, int64_t ignore_index=-100) const;
  virtual Tensor nll_loss(const Tensor & self, const Tensor & target, const Tensor & weight={}, int64_t reduction=Reduction::ElementwiseMean, int64_t ignore_index=-100) const;
  virtual std::tuple<Tensor &,Tensor &> nll_loss_forward_out(Tensor & output, Tensor & total_weight, const Tensor & self, const Tensor & target, const Tensor & weight, int64_t reduction, int64_t ignore_index) const;
  virtual std::tuple<Tensor,Tensor> nll_loss_forward(const Tensor & self, const Tensor & target, const Tensor & weight, int64_t reduction, int64_t ignore_index) const;
  virtual Tensor & nll_loss_backward_out(Tensor & grad_input, const Tensor & grad_output, const Tensor & self, const Tensor & target, const Tensor & weight, int64_t reduction, int64_t ignore_index, const Tensor & total_weight) const;
  virtual Tensor nll_loss_backward(const Tensor & grad_output, const Tensor & self, const Tensor & target, const Tensor & weight, int64_t reduction, int64_t ignore_index, const Tensor & total_weight) const;
  virtual Tensor & nll_loss2d_out(Tensor & output, const Tensor & self, const Tensor & target, const Tensor & weight={}, int64_t reduction=Reduction::ElementwiseMean, int64_t ignore_index=-100) const;
  virtual Tensor nll_loss2d(const Tensor & self, const Tensor & target, const Tensor & weight={}, int64_t reduction=Reduction::ElementwiseMean, int64_t ignore_index=-100) const;
  virtual std::tuple<Tensor &,Tensor &> nll_loss2d_forward_out(Tensor & output, Tensor & total_weight, const Tensor & self, const Tensor & target, const Tensor & weight, int64_t reduction, int64_t ignore_index) const;
  virtual std::tuple<Tensor,Tensor> nll_loss2d_forward(const Tensor & self, const Tensor & target, const Tensor & weight, int64_t reduction, int64_t ignore_index) const;
  virtual Tensor & nll_loss2d_backward_out(Tensor & grad_input, const Tensor & grad_output, const Tensor & self, const Tensor & target, const Tensor & weight, int64_t reduction, int64_t ignore_index, const Tensor & total_weight) const;
  virtual Tensor nll_loss2d_backward(const Tensor & grad_output, const Tensor & self, const Tensor & target, const Tensor & weight, int64_t reduction, int64_t ignore_index, const Tensor & total_weight) const;
  virtual Tensor & smooth_l1_loss_out(Tensor & output, const Tensor & self, const Tensor & target, int64_t reduction=Reduction::ElementwiseMean) const;
  virtual Tensor smooth_l1_loss(const Tensor & self, const Tensor & target, int64_t reduction=Reduction::ElementwiseMean) const;
  virtual Tensor & smooth_l1_loss_forward_out(Tensor & output, const Tensor & self, const Tensor & target, int64_t reduction) const;
  virtual Tensor smooth_l1_loss_forward(const Tensor & self, const Tensor & target, int64_t reduction) const;
  virtual Tensor & smooth_l1_loss_backward_out(Tensor & grad_input, const Tensor & grad_output, const Tensor & self, const Tensor & target, int64_t reduction) const;
  virtual Tensor smooth_l1_loss_backward(const Tensor & grad_output, const Tensor & self, const Tensor & target, int64_t reduction) const;
  virtual Tensor & soft_margin_loss_out(Tensor & output, const Tensor & self, const Tensor & target, int64_t reduction=Reduction::ElementwiseMean) const;
  virtual Tensor soft_margin_loss(const Tensor & self, const Tensor & target, int64_t reduction=Reduction::ElementwiseMean) const;
  virtual Tensor & soft_margin_loss_forward_out(Tensor & output, const Tensor & self, const Tensor & target, int64_t reduction) const;
  virtual Tensor soft_margin_loss_forward(const Tensor & self, const Tensor & target, int64_t reduction) const;
  virtual Tensor & soft_margin_loss_backward_out(Tensor & grad_input, const Tensor & grad_output, const Tensor & self, const Tensor & target, int64_t reduction) const;
  virtual Tensor soft_margin_loss_backward(const Tensor & grad_output, const Tensor & self, const Tensor & target, int64_t reduction) const;
  ...
  virtual Tensor & avg_pool2d_out(Tensor & output, const Tensor & self, IntList kernel_size, IntList stride={}, IntList padding=0, bool ceil_mode=false, bool count_include_pad=true) const;
  virtual Tensor avg_pool2d(const Tensor & self, IntList kernel_size, IntList stride={}, IntList padding=0, bool ceil_mode=false, bool count_include_pad=true) const;
  ...
  virtual Tensor & avg_pool3d_out(Tensor & output, const Tensor & self, IntList kernel_size, IntList stride={}, IntList padding=0, bool ceil_mode=false, bool count_include_pad=true) const;
  virtual Tensor avg_pool3d(const Tensor & self, IntList kernel_size, IntList stride={}, IntList padding=0, bool ceil_mode=false, bool count_include_pad=true) const;
  ...
  virtual std::tuple<Tensor &,Tensor &> max_pool2d_with_indices_out(Tensor & output, Tensor & indices, const Tensor & self, IntList kernel_size, IntList stride={}, IntList padding=0, IntList dilation=1, bool ceil_mode=false) const;
  virtual std::tuple<Tensor,Tensor> max_pool2d_with_indices(const Tensor & self, IntList kernel_size, IntList stride={}, IntList padding=0, IntList dilation=1, bool ceil_mode=false) const;
  virtual std::tuple<Tensor &,Tensor &> max_pool2d_with_indices_forward_out(Tensor & output, Tensor & indices, const Tensor & self, IntList kernel_size, IntList stride, IntList padding, IntList dilation, bool ceil_mode) const;
  virtual std::tuple<Tensor,Tensor> max_pool2d_with_indices_forward(const Tensor & self, IntList kernel_size, IntList stride, IntList padding, IntList dilation, bool ceil_mode) const;
  virtual Tensor & max_pool2d_with_indices_backward_out(Tensor & grad_input, const Tensor & grad_output, const Tensor & self, IntList kernel_size, IntList stride, IntList padding, IntList dilation, bool ceil_mode, const Tensor & indices) const;
  virtual Tensor max_pool2d_with_indices_backward(const Tensor & grad_output, const Tensor & self, IntList kernel_size, IntList stride, IntList padding, IntList dilation, bool ceil_mode, const Tensor & indices) const;
  virtual std::tuple<Tensor &,Tensor &> max_pool3d_with_indices_out(Tensor & output, Tensor & indices, const Tensor & self, IntList kernel_size, IntList stride={}, IntList padding=0, IntList dilation=1, bool ceil_mode=false) const;
  virtual std::tuple<Tensor,Tensor> max_pool3d_with_indices(const Tensor & self, IntList kernel_size, IntList stride={}, IntList padding=0, IntList dilation=1, bool ceil_mode=false) const;
  virtual std::tuple<Tensor &,Tensor &> max_pool3d_with_indices_forward_out(Tensor & output, Tensor & indices, const Tensor & self, IntList kernel_size, IntList stride, IntList padding, IntList dilation, bool ceil_mode) const;
  virtual std::tuple<Tensor,Tensor> max_pool3d_with_indices_forward(const Tensor & self, IntList kernel_size, IntList stride, IntList padding, IntList dilation, bool ceil_mode) const;
  virtual Tensor & max_pool3d_with_indices_backward_out(Tensor & grad_input, const Tensor & grad_output, const Tensor & self, IntList kernel_size, IntList stride, IntList padding, IntList dilation, bool ceil_mode, const Tensor & indices) const;
  virtual Tensor max_pool3d_with_indices_backward(const Tensor & grad_output, const Tensor & self, IntList kernel_size, IntList stride, IntList padding, IntList dilation, bool ceil_mode, const Tensor & indices) const;
  ...
  virtual Tensor & upsample_nearest1d_out(Tensor & output, const Tensor & self, IntList output_size) const;
  virtual Tensor upsample_nearest1d(const Tensor & self, IntList output_size) const;
  virtual Tensor & upsample_nearest1d_forward_out(Tensor & output, const Tensor & self, IntList output_size) const;
  virtual Tensor upsample_nearest1d_forward(const Tensor & self, IntList output_size) const;
  virtual Tensor & upsample_nearest1d_backward_out(Tensor & grad_input, const Tensor & grad_output, IntList output_size, IntList input_size) const;
  virtual Tensor upsample_nearest1d_backward(const Tensor & grad_output, IntList output_size, IntList input_size) const;
  virtual Tensor & upsample_nearest2d_out(Tensor & output, const Tensor & self, IntList output_size) const;
  virtual Tensor upsample_nearest2d(const Tensor & self, IntList output_size) const;
  virtual Tensor & upsample_nearest2d_forward_out(Tensor & output, const Tensor & self, IntList output_size) const;
  virtual Tensor upsample_nearest2d_forward(const Tensor & self, IntList output_size) const;
  virtual Tensor & upsample_nearest2d_backward_out(Tensor & grad_input, const Tensor & grad_output, IntList output_size, IntList input_size) const;
  virtual Tensor upsample_nearest2d_backward(const Tensor & grad_output, IntList output_size, IntList input_size) const;
  virtual Tensor & upsample_nearest3d_out(Tensor & output, const Tensor & self, IntList output_size) const;
  virtual Tensor upsample_nearest3d(const Tensor & self, IntList output_size) const;
  virtual Tensor & upsample_nearest3d_forward_out(Tensor & output, const Tensor & self, IntList output_size) const;
  virtual Tensor upsample_nearest3d_forward(const Tensor & self, IntList output_size) const;
  virtual Tensor & upsample_nearest3d_backward_out(Tensor & grad_input, const Tensor & grad_output, IntList output_size, IntList input_size) const;
  virtual Tensor upsample_nearest3d_backward(const Tensor & grad_output, IntList output_size, IntList input_size) const;
  ...
  virtual Tensor & thnn_grid_sampler_bilinear2d_out(Tensor & output, const Tensor & self, const Tensor & grid, int64_t padding_mode) const;
  virtual Tensor thnn_grid_sampler_bilinear2d(const Tensor & self, const Tensor & grid, int64_t padding_mode) const;
  virtual Tensor & thnn_grid_sampler_bilinear2d_forward_out(Tensor & output, const Tensor & self, const Tensor & grid, int64_t padding_mode) const;
  virtual Tensor thnn_grid_sampler_bilinear2d_forward(const Tensor & self, const Tensor & grid, int64_t padding_mode) const;
  virtual std::tuple<Tensor &,Tensor &> thnn_grid_sampler_bilinear2d_backward_out(Tensor & grad_input, Tensor & grad_grid, const Tensor & grad_output, const Tensor & self, const Tensor & grid, int64_t padding_mode) const;
  virtual std::tuple<Tensor,Tensor> thnn_grid_sampler_bilinear2d_backward(const Tensor & grad_output, const Tensor & self, const Tensor & grid, int64_t padding_mode) const;
  virtual Tensor & thnn_grid_sampler_bilinear3d_out(Tensor & output, const Tensor & self, const Tensor & grid, int64_t padding_mode) const;
  virtual Tensor thnn_grid_sampler_bilinear3d(const Tensor & self, const Tensor & grid, int64_t padding_mode) const;
  virtual Tensor & thnn_grid_sampler_bilinear3d_forward_out(Tensor & output, const Tensor & self, const Tensor & grid, int64_t padding_mode) const;
  virtual Tensor thnn_grid_sampler_bilinear3d_forward(const Tensor & self, const Tensor & grid, int64_t padding_mode) const;
  virtual std::tuple<Tensor &,Tensor &> thnn_grid_sampler_bilinear3d_backward_out(Tensor & grad_input, Tensor & grad_grid, const Tensor & grad_output, const Tensor & self, const Tensor & grid, int64_t padding_mode) const;
  virtual std::tuple<Tensor,Tensor> thnn_grid_sampler_bilinear3d_backward(const Tensor & grad_output, const Tensor & self, const Tensor & grid, int64_t padding_mode) const;
  virtual Tensor _cast_Byte(const Tensor & self, bool non_blocking=false) const;
  virtual Tensor _cast_Char(const Tensor & self, bool non_blocking=false) const;
  ...
  virtual Tensor _cast_Long(const Tensor & self, bool non_blocking=false) const;
  virtual Tensor _cast_Short(const Tensor & self, bool non_blocking=false) const;
  ...
  virtual Tensor avg_pool1d(const Tensor & self, IntList kernel_size, IntList stride={}, IntList padding=0, bool ceil_mode=false, bool count_include_pad=true) const;
  ...
  virtual Tensor & arange_out(Tensor & result, Scalar start, Scalar end) const;
  virtual Tensor & arange_out(Tensor & result, Scalar start, Scalar end, Scalar step) const;
  virtual Tensor & arange_out(Tensor & result, Scalar end) const;
  AT_DEPRECATED(virtual Tensor arange(Scalar start, Scalar end, Scalar step=1) const);
  AT_DEPRECATED(virtual Tensor arange(Scalar end) const);
  virtual Tensor _dim_arange(const Tensor & like, int64_t dim) const;
  ...
  virtual Tensor & as_strided_(Tensor & self, IntList size, IntList stride) const;
  ...
  virtual Tensor bincount(const Tensor & self, const Tensor & weights={}, int64_t minlength=0) const;
  ...
  virtual Tensor cosine_embedding_loss(const Tensor & input1, const Tensor & input2, const Tensor & target, double margin=0.0, int64_t reduction=Reduction::ElementwiseMean) const;
  ...
  virtual std::tuple<Tensor,Tensor,Tensor,Tensor> _embedding_bag(const Tensor & weight, const Tensor & indices, const Tensor & offsets, bool scale_grad_by_freq=false, int64_t mode=0, bool sparse=false) const;
  virtual Tensor _embedding_bag_backward(const Tensor & grad, const Tensor & indices, const Tensor & offsets, const Tensor & offset2bag, const Tensor & bag_size, const Tensor & maximum_indices, int64_t num_weights, bool scale_grad_by_freq, int64_t mode, bool sparse) const;
  virtual Tensor _embedding_bag_sparse_backward(const Tensor & grad, const Tensor & indices, const Tensor & offsets, const Tensor & offset2bag, const Tensor & bag_size, int64_t num_weights, bool scale_grad_by_freq, int64_t mode) const;
  virtual Tensor _embedding_bag_dense_backward(const Tensor & grad, const Tensor & indices, const Tensor & offsets, const Tensor & offset2bag, const Tensor & bag_size, const Tensor & maximum_indices, int64_t num_weights, bool scale_grad_by_freq, int64_t mode) const;
  virtual Tensor & empty_out(Tensor & result, IntList size) const;
  virtual Tensor empty_like(const Tensor & self) const;
  AT_DEPRECATED(virtual Tensor empty(IntList size) const);
  ...
  virtual Tensor & eye_out(Tensor & result, int64_t n) const;
  virtual Tensor & eye_out(Tensor & result, int64_t n, int64_t m) const;
  AT_DEPRECATED(virtual Tensor eye(int64_t n, int64_t m=-1) const);
  virtual Tensor flatten(const Tensor & self, int64_t start_dim=0, int64_t end_dim=-1) const;
  ...
  AT_DEPRECATED(virtual Tensor full(IntList size, Scalar fill_value) const);
  virtual Tensor grid_sampler(const Tensor & input, const Tensor & grid, int64_t padding_mode) const;
  virtual Tensor hinge_embedding_loss(const Tensor & self, const Tensor & target, double margin=1.0, int64_t reduction=Reduction::ElementwiseMean) const;
  ...
  virtual int64_t _cufft_get_plan_cache_size() const;
  virtual int64_t _cufft_get_plan_cache_max_size() const;
  virtual void _cufft_set_plan_cache_max_size(int64_t max_size) const;
  virtual void _cufft_clear_plan_cache() const;
  ...
  virtual Tensor index_put(const Tensor & self, TensorList indices, const Tensor & values) const;
  ...
  virtual Tensor & inverse_out(Tensor & result, const Tensor & self) const;
  ...
  virtual Tensor & linspace_out(Tensor & result, Scalar start, Scalar end) const;
  virtual Tensor & linspace_out(Tensor & result, Scalar start, Scalar end, int64_t steps) const;
  AT_DEPRECATED(virtual Tensor linspace(Scalar start, Scalar end, int64_t steps=100) const);
  ...
  virtual Tensor & logspace_out(Tensor & result, Scalar start, Scalar end) const;
  virtual Tensor & logspace_out(Tensor & result, Scalar start, Scalar end, int64_t steps) const;
  AT_DEPRECATED(virtual Tensor logspace(Scalar start, Scalar end, int64_t steps=100) const);
  ...
  virtual Tensor margin_ranking_loss(const Tensor & input1, const Tensor & input2, const Tensor & target, double margin=0.0, int64_t reduction=Reduction::ElementwiseMean) const;
  ...
  virtual std::tuple<Tensor &,Tensor &> max_out(Tensor & max, Tensor & max_values, const Tensor & self, int64_t dim, bool keepdim=false) const;
  virtual Tensor max_values(const Tensor & self, int64_t dim, bool keepdim=false) const;
  virtual std::tuple<Tensor,Tensor> max_pool1d_with_indices(const Tensor & self, IntList kernel_size, IntList stride={}, IntList padding=0, IntList dilation=1, bool ceil_mode=false) const;
  virtual Tensor max_pool1d(const Tensor & self, IntList kernel_size, IntList stride={}, IntList padding=0, IntList dilation=1, bool ceil_mode=false) const;
  virtual Tensor max_pool2d(const Tensor & self, IntList kernel_size, IntList stride={}, IntList padding=0, IntList dilation=1, bool ceil_mode=false) const;
  virtual Tensor max_pool3d(const Tensor & self, IntList kernel_size, IntList stride={}, IntList padding=0, IntList dilation=1, bool ceil_mode=false) const;
  virtual Tensor mean(const Tensor & self, ScalarType dtype) const;
  virtual Tensor mean(const Tensor & self) const;
  virtual Tensor mean(const Tensor & self, int64_t dim, bool keepdim, ScalarType dtype) const;
  virtual Tensor mean(const Tensor & self, int64_t dim, bool keepdim=false) const;
  virtual Tensor mean(const Tensor & self, int64_t dim, ScalarType dtype) const;
  virtual Tensor & mean_out(Tensor & result, const Tensor & self, int64_t dim, bool keepdim, ScalarType dtype) const;
  virtual Tensor & mean_out(Tensor & result, const Tensor & self, int64_t dim, bool keepdim=false) const;
  virtual Tensor & mean_out(Tensor & result, const Tensor & self, int64_t dim, ScalarType dtype) const;
  ...
  virtual Tensor mkldnn_convolution(const Tensor & self, const Tensor & weight, const Tensor & bias, IntList padding, IntList stride, IntList dilation, int64_t groups) const;
  virtual Tensor mkldnn_convolution_backward_input(IntList self_size, const Tensor & grad_output, const Tensor & weight, IntList padding, IntList stride, IntList dilation, int64_t groups, bool bias_defined) const;
  virtual std::tuple<Tensor,Tensor> mkldnn_convolution_backward_weights(IntList weight_size, const Tensor & grad_output, const Tensor & self, IntList padding, IntList stride, IntList dilation, int64_t groups, bool bias_defined) const;
  virtual std::tuple<Tensor,Tensor,Tensor> mkldnn_convolution_backward(const Tensor & self, const Tensor & grad_output, const Tensor & weight, IntList padding, IntList stride, IntList dilation, int64_t groups, std::array<bool,3> output_mask) const;
  ...
  AT_DEPRECATED(virtual Tensor ones(IntList size) const);
  ...
  virtual Tensor pinverse(const Tensor & self, double rcond=1e-15) const;
  virtual Tensor & rand_out(Tensor & result, IntList size) const;
  virtual Tensor & rand_out(Tensor & result, IntList size, Generator * generator) const;
  virtual Tensor rand_like(const Tensor & self) const;
  AT_DEPRECATED(virtual Tensor rand(IntList size, Generator * generator=nullptr) const);
  AT_DEPRECATED(virtual Tensor randint(int64_t high, IntList size, Generator * generator=nullptr) const);
  AT_DEPRECATED(virtual Tensor randint(int64_t low, int64_t high, IntList size, Generator * generator=nullptr) const);
  virtual Tensor & randint_out(Tensor & result, int64_t high, IntList size) const;
  virtual Tensor & randint_out(Tensor & result, int64_t high, IntList size, Generator * generator) const;
  virtual Tensor & randint_out(Tensor & result, int64_t low, int64_t high, IntList size) const;
  virtual Tensor & randint_out(Tensor & result, int64_t low, int64_t high, IntList size, Generator * generator) const;
  ...
  virtual Tensor & randn_out(Tensor & result, IntList size) const;
  virtual Tensor & randn_out(Tensor & result, IntList size, Generator * generator) const;
  virtual Tensor randn_like(const Tensor & self) const;
  AT_DEPRECATED(virtual Tensor randn(IntList size, Generator * generator=nullptr) const);
  virtual Tensor & randperm_out(Tensor & result, int64_t n) const;
  virtual Tensor & randperm_out(Tensor & result, int64_t n, Generator * generator) const;
  AT_DEPRECATED(virtual Tensor randperm(int64_t n, Generator * generator=nullptr) const);
  virtual Tensor & range_out(Tensor & result, Scalar start, Scalar end) const;
  virtual Tensor & range_out(Tensor & result, Scalar start, Scalar end, Scalar step) const;
  AT_DEPRECATED(virtual Tensor range(Scalar start, Scalar end, Scalar step=1) const);
  ...
  virtual Tensor reshape_as(const Tensor & self, const Tensor & other) const;
  ...
  virtual Tensor hardshrink_backward(const Tensor & grad_out, const Tensor & self, Scalar lambd) const;
  ...
  virtual Tensor stft(const Tensor & self, int64_t n_fft, int64_t hop_length, int64_t win_length, const Tensor & window={}, bool normalized=false, bool onesided=true) const;
  ...
  virtual Tensor flip(const Tensor & self, IntList dims) const;
  ...
  virtual Tensor triplet_margin_loss(const Tensor & anchor, const Tensor & positive, const Tensor & negative, double margin=1.0, double p=2, double eps=1e-06, bool swap=false, int64_t reduction=Reduction::ElementwiseMean) const;
  ...
  AT_DEPRECATED(virtual Tensor zeros(IntList size) const);
  ...
  virtual Tensor native_norm(const Tensor & self, Scalar p=2) const;
  ...
  virtual Tensor native_clone(const Tensor & self) const;
  virtual Tensor clone(const Tensor & self) const;
  virtual Tensor & native_resize_as_(Tensor & self, const Tensor & the_template) const;
  virtual Tensor & resize_as_(Tensor & self, const Tensor & the_template) const;
  virtual Tensor & native_pow_out(Tensor & result, const Tensor & self, Scalar exponent) const;
  virtual Tensor native_pow(const Tensor & self, Scalar exponent) const;
  ...
  virtual Tensor & native_zero_(Tensor & self) const;
  virtual Tensor & zero_(Tensor & self) const;
  virtual Tensor & s_native_add_out(Tensor & result, const Tensor & self, const Tensor & other, Scalar alpha=1) const;
  virtual Tensor & native_add_out(Tensor & result, const Tensor & self, SparseTensorRef other, Scalar alpha=1) const;
  virtual Tensor s_native_add(const Tensor & self, const Tensor & other, Scalar alpha=1) const;
  virtual Tensor native_add(const Tensor & self, SparseTensorRef other, Scalar alpha=1) const;
  virtual Tensor & s_native_add_(Tensor & self, const Tensor & other, Scalar alpha=1) const;
  virtual Tensor & native_add_(Tensor & self, SparseTensorRef other, Scalar alpha=1) const;
  virtual Tensor & add_out(Tensor & result, const Tensor & self, const Tensor & other, Scalar alpha=1) const;
  virtual Tensor add(const Tensor & self, const Tensor & other, Scalar alpha=1) const;
  virtual Tensor & add_(Tensor & self, const Tensor & other, Scalar alpha=1) const;
  virtual Tensor & s_native_sub_out(Tensor & result, const Tensor & self, const Tensor & other, Scalar alpha=1) const;
  virtual Tensor s_native_sub(const Tensor & self, const Tensor & other, Scalar alpha=1) const;
  virtual Tensor & s_native_sub_(Tensor & self, const Tensor & other, Scalar alpha=1) const;
  virtual Tensor & sub_out(Tensor & result, const Tensor & self, const Tensor & other, Scalar alpha=1) const;
  virtual Tensor sub(const Tensor & self, const Tensor & other, Scalar alpha=1) const;
  virtual Tensor & sub_(Tensor & self, const Tensor & other, Scalar alpha=1) const;
  virtual Tensor & s_native_mul_out(Tensor & result, const Tensor & self, const Tensor & other) const;
  virtual Tensor s_native_mul(const Tensor & self, const Tensor & other) const;
  virtual Tensor & s_native_mul_(Tensor & self, const Tensor & other) const;
  virtual Tensor & native_mul_out(Tensor & result, const Tensor & self, Scalar other) const;
  virtual Tensor native_mul(const Tensor & self, Scalar other) const;
  virtual Tensor & native_mul_(Tensor & self, Scalar other) const;
  virtual Tensor & mul_out(Tensor & result, const Tensor & self, const Tensor & other) const;
  virtual Tensor & mul_out(Tensor & result, const Tensor & self, Scalar other) const;
  virtual Tensor mul(const Tensor & self, const Tensor & other) const;
  virtual Tensor mul(const Tensor & self, Scalar other) const;
  virtual Tensor & mul_(Tensor & self, const Tensor & other) const;
  virtual Tensor & mul_(Tensor & self, Scalar other) const;
  virtual Tensor & native_div_out(Tensor & result, const Tensor & self, Scalar other) const;
  virtual Tensor native_div(const Tensor & self, Scalar other) const;
  virtual Tensor & native_div_(Tensor & self, Scalar other) const;
  ...
  virtual Tensor & s_native_addmm_out(Tensor & result, const Tensor & self, const Tensor & mat1, const Tensor & mat2, Scalar beta=1, Scalar alpha=1) const;
  virtual Tensor s_native_addmm(const Tensor & self, const Tensor & mat1, const Tensor & mat2, Scalar beta=1, Scalar alpha=1) const;
  virtual Tensor & s_native_addmm_(Tensor & self, const Tensor & mat1, const Tensor & mat2, Scalar beta=1, Scalar alpha=1) const;
  virtual Tensor & addmm_out(Tensor & result, const Tensor & self, const Tensor & mat1, const Tensor & mat2, Scalar beta=1, Scalar alpha=1) const;
  virtual Tensor addmm(const Tensor & self, const Tensor & mat1, const Tensor & mat2, Scalar beta=1, Scalar alpha=1) const;
  virtual Tensor & addmm_(Tensor & self, const Tensor & mat1, const Tensor & mat2, Scalar beta=1, Scalar alpha=1) const;
  virtual Tensor native_tensor() const;
  virtual Tensor native_tensor(IntList size) const;
  virtual Tensor tensor() const;
  virtual Tensor tensor(IntList size) const;
  virtual Tensor native_sparse_coo_tensor(const Tensor & indices, const Tensor & values) const;
  virtual Tensor native_sparse_coo_tensor(const Tensor & indices, const Tensor & values, IntList size) const;
  ...
  virtual Tensor _native_sparse_coo_tensor_unsafe(const Tensor & indices, const Tensor & values, IntList size) const;
  virtual Tensor _sparse_coo_tensor_unsafe(const Tensor & indices, const Tensor & values, IntList size) const;
  virtual Tensor & sparse_raw_resize_(Tensor & self, IntList size, int64_t sparseDims, int64_t denseDims) const;
  virtual Tensor _sparse_mask(const Tensor & self, SparseTensorRef mask) const;
  virtual Tensor to_dense(const Tensor & self) const;
  virtual int64_t _sparseDims(const Tensor & self) const;
  virtual int64_t _dimI(const Tensor & self) const;
  virtual int64_t _denseDims(const Tensor & self) const;
  ...
  virtual Tensor & raw_copy_sparse_(Tensor & self, const Tensor & src) const;
  virtual int64_t numel(const Tensor & self) const;
  virtual std::vector<Tensor> unbind(const Tensor & self, int64_t dim=0) const;
  virtual int64_t native_get_device(const Tensor & self) const;
  virtual int64_t get_device(const Tensor & self) const;
  virtual std::vector<Tensor> meshgrid(TensorList tensors) const;
protected:
  Context* context;
  bool is_variable_;
  bool is_undefined_;
